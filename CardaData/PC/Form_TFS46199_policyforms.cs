...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Form_TFS46199_policyforms recording.
    /// </summary>
    [TestModule("386b5f10-11e3-4555-b770-fbbd98557d95", ModuleType.Recording, 1)]
    public partial class Form_TFS46199_policyforms : ITestModule
    {
        /// <summary>
        ...
        static Form_TFS46199_policyforms instance = new Form_TFS46199_policyforms();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Form_TFS46199_policyforms()
        {
            NomArch_TFS46199_policy_forms = "TFS46199_policy forms.xml";
        }

        /// <summary>
        /// Gets a static instance of this recording.
        /// </summary>
        public static Form_TFS46199_policyforms Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        string _NomArch_TFS46199_policy_forms;

        /// <summary>
        /// Gets or sets the value of variable NomArch_TFS46199_policy_forms.
        /// </summary>
        [TestVariable("dae94327-fa96-4637-a7be-a4f8a886b47a")]
        public string NomArch_TFS46199_policy_forms
        {
            get { return _NomArch_TFS46199_policy_forms; }
            set { _NomArch_TFS46199_policy_forms = value; }
        }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$NomArch_TFS46199_policy_forms'.", new RecordItemIndex(6));
            Keyboard.Press(NomArch_TFS46199_policy_forms);
            Delay.Milliseconds(0);
