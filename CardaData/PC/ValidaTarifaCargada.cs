...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 30s to exist. Associated repository item: 'ApplicationUnderTest.lbl_CodigoDeProductor2302'", repo.ApplicationUnderTest.lbl_CodigoDeProductor2302Info, new ActionTimeout(30000), new RecordItemIndex(2));
            repo.ApplicationUnderTest.lbl_CodigoDeProductor2302Info.WaitForExists(30000);
