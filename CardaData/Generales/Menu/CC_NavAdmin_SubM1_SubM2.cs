...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Move item 'ApplicationUnderTest.Nav_SubM2' at Center.", repo.ApplicationUnderTest.Nav_SubM2Info, new RecordItemIndex(5));
            repo.ApplicationUnderTest.Nav_SubM2.MoveTo();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 40s to exist. Associated repository item: 'ApplicationUnderTest.Nav_SubM2_Visible'", repo.ApplicationUnderTest.Nav_SubM2_VisibleInfo, new ActionTimeout(40000), new RecordItemIndex(6));
            repo.ApplicationUnderTest.Nav_SubM2_VisibleInfo.WaitForExists(40000);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.Nav_SubM2_Visible' at Center.", repo.ApplicationUnderTest.Nav_SubM2_VisibleInfo, new RecordItemIndex(7));
